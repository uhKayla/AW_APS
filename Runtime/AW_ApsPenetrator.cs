...
{
    [AddComponentMenu("ANGELWARE/APS/Penetrator")]
    ...
    public class AW_ApsPenetratorPlugin : AacPlugin<AW_ApsPenetrator>
    {
        protected override AacPluginOutput Execute()
        {
            ...
            #region Parameters
            my.paramList.Add(new Parameter{parameter = $"APS/NSFW/{my.parameterName}"});
            my.paramList.Add(new Parameter{parameter = my.speedMultiplierParam, value = my.speedMultiplier});
            my.paramList.Add(new Parameter{parameter = "APS/Multiplied/WetnessSpeed"});
            my.paramList.Add(new Parameter{parameter = "Internal/APS/WetnessSpeed", value = my.speedMultiplier});
            my.paramList.Add(new Parameter{parameter = $"APS/NSFW/{my.parameterName}"});
            my.paramList.Add(new Parameter{parameter = $"APS/NSFW/Smooth/{my.parameterName}"});
